...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Dialix — AI Voice Call Center',
    description: 'Automate your outbound calls with AI voice agents. Built for sales teams, support, and campaigns.',
  ...
  twitter: {
    ...
    title: 'Dialix — AI Voice Call Center',
    description: 'Automate your outbound calls with AI voice agents.',
  },
  robots: {
    index: true,
    follow: true,
