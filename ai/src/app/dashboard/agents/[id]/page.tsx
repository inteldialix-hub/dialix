    ...
    <div className="max-w-7xl mx-auto px-6 py-6">
      ...
      <div className="mt-6 pb-24">
        {activeTab === 'configuration' && (
          ...
          {/* Gemini Context & Tools — only shown for Gemini agents */}
          {provider === 'gemini' && (
            <div className="rounded-lg border border-border bg-card p-6">
              <h3 className="text-sm font-medium mb-1 flex items-center gap-2"><Sliders className="size-4" /> Context & Tools</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mb-2">Conversation history is compressed when it reaches this limit.</p>
