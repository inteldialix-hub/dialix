...
interface IntegrationsHubClientProps {
  integrations: ProgrammaticPageData[];
}

export default function IntegrationsHubClient({ integrations }: IntegrationsHubClientProps) {
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        ...
        <header className="mt-4 mb-10 text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full text-xs font-semibold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mb-4">
            ...
            <span>100+ Enterprise Voice Integrations</span>
          </div>

          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-white mb-4 leading-tight">
            Connect Dialix Voice AI to Your Full Tech Stack
          </h1>

          <p className="text-base sm:text-lg text-zinc-300 leading-relaxed font-normal">
            Browse turnkey integrations across workflow automation, LLM models, CRMs, telephony carriers, and vector databases. Deploy voice agents with sub-200ms latency and 99.99% reliability.
          </p>
          ...
          <div className="mt-8 relative max-w-xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search 100+ integrations (e.g. n8n, Salesforce, Twilio, Claude)..."
        ...
        <section className="my-10">
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-16 rounded-2xl bg-[#111317] border border-white/[0.08]">
              ...
              <h3 className="text-base font-semibold text-white mb-1">No integrations found</h3>
              ...
              {filtered.map((item) => (
                ...
                >
                  ...
                  <div className="pt-3 border-t border-white/[0.04] flex items-center justify-between text-[11px] text-zinc-500 font-mono">
                    <span>{item.entities.protocols[0]}</span>
                    <span className="text-emerald-400 font-medium">187ms Latency</span>
                  </div>
                </Link>
              ))}
            </div>
